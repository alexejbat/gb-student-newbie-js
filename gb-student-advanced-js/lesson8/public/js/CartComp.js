...
const cart = {
    ...
    data () {
        return {
            ...
            imgCart: '/lesson8/public/img/2.jpg',
            cartShown: false,
            cartItems: []
        }
    },
    ...
    template: `
    <div>
        <input class="cart-button" type="image" src="/lesson8/public/img/cart.svg" @click="cartShown = !cartShown"></input>
